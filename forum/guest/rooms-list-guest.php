...
<head>
	...
	<script type="text/javascript">
		$(function() {
			...
			//script to load rooms for a guest user
			//the rooms will be loaded depending on the category given
			var first = 0;	
			var second = 9;
			$(".loadin-more").hide();
