...
/*
	this is the welcome page were a user will be redericted to when he logs in
	he will find a lisf of last rooms and categories
*/
?>
		...
		<div id="left-container">
			...
			<div class="last-categories-list">
				<?php
					...
					if ($Categories_list!="empty") {	
						...
						foreach ($Categories_list as $Cat) {//using a foreach loop to display the list of the last 6 categories
							?>
							<a href="rooms-list.php?category=<?php echo $Cat->CATID; ?>" class="category-div">
				...
				<div class="see-more-wide-div">
					<a href="categories-list.php" class="see-more-home">See all &#10145;</a>	
				</div>
			</div>
			...
			<div class="last-rooms-list"><!--the last six rooms-->
				...
				<div class="see-more-wide-div">
					<a href="rooms.php" class="see-more-home">See all &#10145;</a>	
				</div>				
