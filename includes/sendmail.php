...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['form_name'] != '' AND $_POST['form_email'] != '' AND $_POST['form_subject'] != '' ) {
        ...
        $subject = isset($subject) ? $subject : 'Programme Registration |Digititan';

        $botcheck = $_POST['form_botcheck'];

        $toemail = 'dennism@titant.co.za'; // Your Email Address
        $toname = 'New Digititan Submission'; // Your Name
