<?php
/*
This page will shwo a list of rooms depending on the category chosen
the Admin will be able to delete some rooms ifhe wants he will have all the control on the rooms
*/
...
<body>
	...
	<div id="container" style="margin-top:200px;">
								...
								<a href="subjects-admin.php?room=<?php echo $Ro->ID; ?>" class="room-div" id="room-div-<?php echo $Ro->ID; ?>">
									<div class="room-top" style="background-image:url(../avatars/room/<?php echo $Ro->Image; ?>)">
										...
										<div class="room-pending-action">
											<div class="RedGradient"  onclick="deleteRoom(event,<?php echo $Ro->ID; ?>);">Delete</div>
										</div>
									</div>
		...
		<div id="side_bar_right_admin">
			<div id="create-new-room" class="create-new">Create new room</div>
		...
		<div id="create-room-div" >
			...
			<div class="create-room-inputs">
				<form action="../api/api.php" method="post" enctype="multipart/form-data" class="create-room-inputs">
					...
					<input type="hidden" name="User" id="create-room-user" value="1">
